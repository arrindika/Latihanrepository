...
Feature: Sign Up
  ...
  git remote add origin https://github.com/andikabhaskara/LatihanRepo.git  Then User will see otp page
    Examples:
  ...
  Scenario Outline: verify the error message functionality of sign up on Sigma Application
    ...
    Examples:
      ...
      | Reza Rahardian | reza.rahardian@gmail.com | 628190410707070 | Password@123_ | Password@123_  |
